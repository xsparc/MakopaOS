...
The static evidence check validates schema, traceability, local references, and
accepted-decision coverage. The dated strict check additionally blocks overdue
reviews. Both commands are offline and use only the Python standard library.
